            ...
            {step === 1 ? (
              ...
              >
                ...
                <Button type="submit" className="w-full" disabled={isLoading}>
                  {isLoading ? "İşleniyor..." : "Devam Et"} <ArrowRight className="h-4 w-4 ml-1" />
                </Button>
              </form>
            ) : (
              <form
                ...
                onSubmit={async (e) => {
                  ...
                  if (!data.sat) {
                    toast({
                      title: "Eksik bilgi",
                      description: "Lütfen son adet tarihinizi (SAT) seçin.",
                      variant: "destructive",
                    });
                    return;
                  }
                  const kiloNum = parseFloat(String(data.kilo).replace(",", "."));
                  if (!Number.isFinite(kiloNum) || kiloNum <= 0) {
                    toast({
                      title: "Eksik bilgi",
                      description: "Lütfen geçerli bir başlangıç kilosu girin.",
                      variant: "destructive",
                    });
                    return;
                  }
              ...
              >
                ...
                <div className="flex gap-2 pt-2">
                  ...
                  <Button type="submit" className="flex-1" disabled={isLoading}>
                    {isLoading ? "Kayıt yapılıyor..." : "Başla"}
                  </Button>
                </div>
              </form>
            )}
